...
const initialProjects = [
  {
    id: 1,
    title: "Carpooling System",
    desc: "JavaFX app connecting drivers and passengers for ride sharing",
    fullDesc: "Create and browse trips, manage schedules, and reduce costs and environmental impact.",
    tech: ["JavaFX", "Java", "MySQL", "Scene Builder"],
  ...
  },
  {
    id: 2,
    title: "World Cup Dashboard",
    desc: "Interactive Power BI dashboard with Flask for performance insights",
    fullDesc: "Explore World Cup stats, trends, and personalized insights through a web interface.",
    tech: ["Power BI", "Flask", "Python", "Data Viz"],
  ...
  },
  {
    id: 3,
    title: "Sign Language Translator",
    desc: "Real-time sign language to text translator using webcam",
    fullDesc: "Capture gestures and convert them to text instantly with a deep learning model.",
    tech: ["Python", "Streamlit", "OpenCV", "TensorFlow", "MediaPipe"],
  ...
  },
  {
    ...
    desc: "Real-time GPS tracking extension for Business Central",
    fullDesc: "Monitor fleet positions and trip history, and manage logistics directly from ERP.",
  ...
  },
  {
    ...
    desc: "Upload retinal images to predict eye diseases with AI",
    fullDesc: "Detect Cataract, Glaucoma, or Retinopathy using a deep learning model deployed in React.",
